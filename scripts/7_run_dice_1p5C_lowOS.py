...
mkdir_p(os.path.join(here, '..', 'data_output', 'dice_1p5deglowOS'))
...
* Program control definitions
        ...
        tearly(t) = yes$(t.val lt 17);
        tlate(t)  = yes$(t.val ge 18);
...
*Climate and carbon cycle
        ...
        constrainT(t)    limit long-term warming to 1.5 degrees
        lowOS(t)         limit peak warming to 1.6 degrees
...
* Climate and carbon cycle
 ...
 constrainT(tlate)..  TATM(tlate)    =L= 1.5;
 lowOS(tearly)..      TATM(tearly)   =L= 1.6;
...
file results /"{here}/../data_output/dice_1p5deglowOS/{run:04d}.csv"/; results.nd = 10 ; results.nw = 0 ; results.pw=20000; results.pc=5;
put results;
put // "Period";
Loop (T, put T.val);
put / "Year" ;
