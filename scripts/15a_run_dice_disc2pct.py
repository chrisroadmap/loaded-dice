...
os.makedirs(os.path.join(here, '..', 'data_output', 'dice_disc2pct'), exist_ok=True)
...
** Preferences
        elasmu   Elasticity of marginal utility of consumption         /0.20/
        prstp    Initial rate of social time preference per year       /0.0124/
...
file results /"{here}/../data_output/dice_disc2pct/{config:07d}.csv"/; results.nd = 10 ; results.nw = 0 ; results.pw=20000; results.pc=5;
put results;
put // "Period";
Loop (T, put T.val);
put / "Year" ;
