...
df_nonco2 = pd.read_csv(os.path.join(here, '..', 'data_output', 'climate_configs', 'anthropogenic_non-co2_forcing_future_ssp119.csv'), index_col=0)
...
df_temp = pd.read_csv(os.path.join(here, '..', 'data_output', 'climate_configs', 'temperature_2023_ssp119.csv'), index_col=0)
...
** Preferences
        elasmu   Elasticity of marginal utility of consumption         /0.12/
        prstp    Initial rate of social time preference per year       /0.0012/
